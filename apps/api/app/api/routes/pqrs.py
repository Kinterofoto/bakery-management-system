...
<body style="margin: 0; padding: 0; background-color: #f9fafb; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="background: linear-gradient(135deg, #ef4444, #dc2626); border-radius: 16px 16px 0 0; padding: 32px; text-align: center;">
      <h1 style="color: white; margin: 0; font-size: 22px; font-weight: 600;">PastriChef</h1>
    ...
    <p style="text-align: center; color: #9ca3af; font-size: 12px; margin-top: 24px;">
      Este correo fue enviado desde el Sistema de Gestion de Calidad de PastriChef.
    </p>
  </div>
</body>
</html>
...
async def send_resolution_email(request: SendResolutionRequest):
    ...
    try:
        ...
        subject = f"Resolucion de {pqrs_label} #{request.pqrs_id[:8]} - PastriChef Calidad"
