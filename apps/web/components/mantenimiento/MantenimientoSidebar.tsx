...
const navItems: NavItem[] = [
  ...
  {
    label: "Cronograma",
    href: "/mantenimiento/cronograma",
    icon: <Calendar className="w-5 h-5" />,
    color: "text-green-500"
  },
  {
    label: "Infraestructura",
    href: "/mantenimiento/infraestructura",
  ...
  {
    label: "Registros",
    href: "/mantenimiento/registros-diarios",
    icon: <FileCheck className="w-5 h-5" />,
    color: "text-cyan-500"
  },
  {
    label: "Fichas Técnicas",
    href: "/mantenimiento/fichas-tecnicas",
    icon: <FileText className="w-5 h-5" />,
    color: "text-slate-500"
  },
  {
    label: "Hojas de Vida",
    href: "/mantenimiento/hojas-de-vida",
    icon: <History className="w-5 h-5" />,
    color: "text-rose-500"
  },
]

export function MantenimientoSidebar() {
  ...
  const isActive = (href: string) => {
    if (href === "/mantenimiento") return pathname === "/mantenimiento"
