...
function CoverPage({ logoUrl, generatedDate }: { logoUrl: string; generatedDate: string }) {
  return (
    <Page size="A4" style={styles.coverPage}>
      ...
      <Text style={styles.coverSubtitle}>Pastry Industrial</Text>
      ...
      <Page size="A4" style={styles.page} wrap>
        ...
        <View style={styles.header} fixed>
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
            ...
            <Text style={styles.headerTitle}>Pastry Industrial</Text>
          </View>
        ...
        <View style={styles.footer} fixed>
          <Text style={styles.footerText}>Pastry Industrial - Catalogo de Productos</Text>
