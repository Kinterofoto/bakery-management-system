-- =====================================================
-- Migration: Add batch_number and expiry_date parameters to perform_inventory_movement
-- =====================================================
-- Purpose: Support batch tracking in material receptions and movements
-- Date: 2025-12-02
-- =====================================================
...
'Core function to create inventory movements with batch and expiry tracking support.';
