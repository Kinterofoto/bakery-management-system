-- =====================================================
-- Migration: Fix location validation order in perform_inventory_movement
-- =====================================================
-- Purpose: Assign default location BEFORE validating, not after
-- Date: 2025-12-02
-- =====================================================

DROP FUNCTION IF EXISTS inventario.perform_inventory_movement(UUID, DECIMAL, VARCHAR, VARCHAR, UUID, UUID, UUID, VARCHAR, TEXT, UUID, VARCHAR, DATE);
...
COMMENT ON FUNCTION inventario.perform_inventory_movement IS
'Core function to create inventory movements. Assigns default location before validation.';
