-- =====================================================
-- Migration: Fix unit_of_measure reference in perform_inventory_movement
-- =====================================================
-- Purpose: Change unit_of_measure to unit (correct column name in products table)
-- Date: 2025-12-01
-- =====================================================
...
BEGIN
  ...
  -- 5. Get product unit of measure (FIXED: using 'unit' instead of 'unit_of_measure')
...
COMMENT ON FUNCTION inventario.perform_inventory_movement IS 'Core function to create inventory movements with automatic balance calculation (FIXED: uses correct column name "unit")';
