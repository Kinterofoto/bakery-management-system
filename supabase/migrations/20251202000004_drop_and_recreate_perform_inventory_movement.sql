-- =====================================================
-- Migration: Drop and recreate perform_inventory_movement with fixed logic
-- =====================================================
-- Purpose: The previous migration created a duplicate function.
--          This migration properly drops all versions and recreates with fix.
-- Date: 2025-12-02
-- =====================================================
...
CREATE FUNCTION inventario.perform_inventory_movement(
  p_product_id UUID,
  p_quantity DECIMAL,
...
FIXED: Now correctly determines affected location based on movement type (OUT/TRANSFER_OUT use FROM, IN/TRANSFER_IN use TO).';
