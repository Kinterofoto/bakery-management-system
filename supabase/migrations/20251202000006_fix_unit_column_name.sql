-- =====================================================
-- Migration: Fix unit_of_measure column name reference
-- =====================================================
-- Purpose: Change reference from unit_of_measure to unit in products table
-- Date: 2025-12-02
-- =====================================================
...
BEGIN
  ...
  -- 5. Get product unit of measure (FIXED: column is 'unit' not 'unit_of_measure')
...
FIXED: Changed unit_of_measure to unit to match products table schema.';
